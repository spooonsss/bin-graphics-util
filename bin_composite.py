...
if __name__ == '__main__':
    parser = argparse.ArgumentParser(prog='bin_composite', description='Combines two SNES .bin graphics files by pasting one on top of the other.', epilog='input_filename2 appears on top')
    ...
    parser.add_argument('--bpp', type=int, default=4, help='bpp (default 4)')
    parser.add_argument('input_filename1')
    parser.add_argument('input_filename2', help='This .bin appears on top')
    parser.add_argument('output_filename')

    args = parser.parse_args()

    composite(args.input_filename1, args.input_filename2, args.output_filename, args.bpp, args.width, args.height)
